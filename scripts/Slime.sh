...
change_xfce_terminal() {
	...
	sed -i -e 's/ColorPalette=.*/ColorPalette=#38383a3a4242;#e4e456564949;#5050a1a14f4f;#c1c184840101;#01018484bcbc;#a6a62626a4a4;#09099797b3b3;#909090909090;#38383a3a4242;#e4e456564949;#5050a1a14f4f;#c1c184840101;#01018484bcbc;#a6a62626a4a4;#09099797b3b3;#909090909090/g' ${xfce_term_path}/terminalrc
}
...
# funct WALLPAPER
set_wallpaper 'slime.jpg'

# funct STYLE FONT
change_polybar 'slime' 'Iosevka Nerd Font:size=10;3' && "$polybar_path"/launch.sh

# funct STYLE FONT BORDER BORDER-RADIUS ICON (Change colors in funct)
change_rofi 'slime' 'Iosevka 10' '0px' '0px' 'Papirus-Apps'
...
# funct SCHEME FONT
change_geany 'slime' 'Iosevka Custom 10'

# funct THEME ICON CURSOR FONT
change_appearance 'Slime' 'Luv-Folders' 'Qogirr-dark' 'Noto Sans 9'

# funct THEME LAYOUT FONT SIZE (Change margin in funct)
obconfig 'Slime' 'CLM' 'JetBrains Mono' '9' 'menu-simple.xml' && openbox --reconfigure
