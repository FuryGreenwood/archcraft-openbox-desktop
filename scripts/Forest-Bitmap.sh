...
# funct STYLE FONT
change_polybar 'forest-bitmap' 'Terminus:Medium:size=9;2' && "$polybar_path"/launch.sh

# funct STYLE FONT BORDER BORDER-RADIUS ICON (Change colors in funct)
change_rofi 'forest-bitmap' 'Terminus Medium 9' '0px' '0px' 'Papirus-Apps'

# funct STYLE (network manager applet)
change_nm 'forest-bitmap'
...
change_appearance 'Adapta-Nokto-Eta' 'Archcraft-Dark' 'Pear' 'Terminus Medium 9'
